...
public:
    ...
    void Mostrar(){
        cout<<"CODIGO TOUR: "<<codigoTour<<endl;
        cout<<"NOMBRE: "<<nombre<<endl;
        cout<<"TIPO: "<<tipo<<endl;
        if(estado==false) cout<<"BORRADO";
        cout<<endl<<endl;
...
public:
    ...
    void Mostrar(){
        ...
        cout<<"CODIGO DE TOUR: "<<codigoTour<<endl;
        cout<<"NUMERO DE CLIENTE: "<<numeroDeCliente<<endl;
        cout<<"ID PERSONAL: "<<IDpersonal<<endl;
